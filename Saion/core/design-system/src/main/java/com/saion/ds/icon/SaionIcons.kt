...
import com.saion.ds.icon.vector.IcBell
...
object SaionIcons {
    val Logo: ImageVector = SaionLogo
    val Symbol: ImageVector = SaionSymbol
    val KakaoLogo: ImageVector = IcKakaoLogo
